...
//setters are similar to getters. I understand HOW but not WHY. The use case isn't clear
const robot = {
  _model: "1E78V2",
  _energyLevel: 100,
  _numOfSensors: 15,
...
//factory functions are used to create multiple objects simultaneously
